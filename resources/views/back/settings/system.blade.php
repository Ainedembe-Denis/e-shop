                                                ...
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="currency_direction" id="currency_direction" class="form-control">
                                                            <option value="1" {{$setting->currency_direction == 1 ? 'selected' : ''}}>{{__('Left (UGX100.00)')}}</option>
                                                            <option value="0" {{$setting->currency_direction == 0 ? 'selected' : ''}}>{{__('Right (100.00UGX)')}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div id="social-section">
                                                                        <div class="text-right">
                                                                            <button type="button" class="btn btn-success add-social ml-2" data-text="{{ __('Social Link') }}"> <i class="fa fa-plus"></i> </button>
                                                                        </div>
                                                                        @php
                                                                        ...
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <div class="flex-btn">
                                                                                ...
                                                                                <button type="button" class="btn btn-danger remove-social" data-text="{{ __('Social Link') }}"> <i class="fa fa-minus"></i> </button>
                                                                            </div>
                                                                        </div>
                                                                        @endforeach
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="facebook_messenger" class="form-control" id="" placeholder="{{ __('Facebook Messenger Page Id') }}">{{ $setting->facebook_messenger }}</textarea>
                                                    </div>
